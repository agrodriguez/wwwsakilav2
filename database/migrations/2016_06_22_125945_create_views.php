...
class CreateViews extends Migration
{
        ...
        DB::unprepared('
            ...
            GROUP_CONCAT(DISTINCT CONCAT(c.name, \': \',
                    (SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR \', \')
                                FROM sakilav2.film f
                                INNER JOIN sakilav2.film_category fc
                                  ON f.film_id = fc.film_id
                                INNER JOIN sakilav2.film_actor fa
            ...
            AS film_info
            FROM sakilav2.actor a
            LEFT JOIN sakilav2.film_actor fa
              ON a.actor_id = fa.actor_id
            LEFT JOIN sakilav2.film_category fc
              ON fa.film_id = fc.film_id
            LEFT JOIN sakilav2.category c
    ...
    {
        DB::unprepared('DROP VIEW customer_list');
        DB::unprepared('DROP VIEW film_list');
        DB::unprepared('DROP VIEW nicer_but_slower_film_list');
        DB::unprepared('DROP VIEW staff_list');
        DB::unprepared('DROP VIEW sales_by_store');
        DB::unprepared('DROP VIEW sales_by_film_category');
        DB::unprepared('DROP VIEW actor_info');
    }
}
