...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
				...
				{!! Form::model($staff,['action'=>['StaffsController@update',$staff->{'slug'}, 'locale' => App::getLocale() ],'method'=>'PATCH','class'=>'form-horizontal col-sm-offset-0','files'=>true]) !!}
				...
				{!! Form::model($staff,['action'=>['StaffsController@destroy',$staff->{'slug'}, 'locale' => App::getLocale() ],'method'=>'DELETE','class'=>'form-horizontal']) !!}
