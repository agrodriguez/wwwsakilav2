            <div class="panel panel-default">
                ...
                <div class="panel-body"><a class="btn btn-primary pull-left" href="{{ action('FilmsController@create', ['locale'=>App::getLocale() ]) }}" title="{{ trans('film.create') }}" alt="{{ trans('film.create') }}">{{ trans('film.create') }}</a></div>
