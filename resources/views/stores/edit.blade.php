...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
				...
				{!! Form::model($store,['action'=>['StoresController@update',$store->{'store_id'}, 'locale' => App::getLocale() ],'method'=>'PATCH','class'=>'form-horizontal col-sm-offset-0','files'=>true]) !!}
                ...
                {!! Form::model($store,['action'=>['StoresController@destroy',$store->{'store_id'}, 'locale' => App::getLocale() ],'method'=>'DELETE','class'=>'form-horizontal', 'id' => 'delete_form']) !!}
