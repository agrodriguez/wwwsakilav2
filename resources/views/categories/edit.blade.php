...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
				...
				{!! Form::model($category,['action'=>['CategoriesController@update',$category->{'name'}, 'locale' => App::getLocale() ],'method'=>'PATCH','class'=>'form-horizontal col-sm-offset-0']) !!}
						
						@include('categories._form',['submitButtonText' => trans('category.update')])

				{!! Form::close() !!}
				<h2><p class="lead"> {{ trans('category.delete') }} </p></h2>
                {!! Form::model($category,['action'=>['CategoriesController@destroy',$category->{'name'}, 'locale' => App::getLocale() ],'method'=>'DELETE','class'=>'form-horizontal', 'id' => 'delete_form']) !!}
